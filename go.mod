module github.com/tommzn/utte-lock
...
require (
	...
	github.com/tommzn/go-config v1.2.1 // indirect
	...
	github.com/tommzn/utte-core v1.0.0 // indirect
	github.com/tommzn/utte-model v1.0.1 // indirect
